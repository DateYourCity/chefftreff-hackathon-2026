...
const CONNECT_DATA_SOURCES_ACTION: ChatContextAction = {
    label: "Connect additional data sources",
    href: "/data_connections",
};
...
export type DailyCheckInChatContext = {
    ...
    intro: string;
    introActions?: ChatContextAction[];
    summaryTitle: string;
    summaryTheme: string;
};
...
export function buildDailyCheckInChatContext(input: {
    ...
    return {
        kind: "daily-checkin",
        introActions: [CONNECT_DATA_SOURCES_ACTION],
        ...input,
    };
}
