...
function getDoctorAppointmentAction(question: string): MessageAction | null {
    const normalized = question.toLowerCase();
    ...
    if (
        ...
        normalized.includes("arzttermin")
    ) {
        return {
            label: "Open Medical tab",
...
function getMockedAssistantReply(question: string) {
    const action = getDoctorAppointmentAction(question);
    ...
    return {
        content:
            "I can route you to your medical overview so you can review visits and next steps for a doctor appointment.",
        actions: [action],
    };
}
...
export default function ChatPage() {
    ...
    const sendMessage = async () => {
        ...
        try {
            const mockedAssistantReply = getMockedAssistantReply(trimmed);

            if (mockedAssistantReply) {
                const assistantMessage: Message = {
                    id: `a-${Date.now()}`,
                    role: "assistant",
                    content: mockedAssistantReply.content,
                    actions: mockedAssistantReply.actions,
                };
